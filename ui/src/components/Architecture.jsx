...
// honest "N/A" + "live value unavailable" caption, never a stale or invented
	...
	return (
		<div className="max-w-[820px] mb-7">
			...
			<p className="body" style={{ color: "var(--text-3)" }}>
				This page describes what runs today on the Arc public testnet. Upcoming
				work is labeled as roadmap.
			</p>
		</div>
	);
}

// Skeleton → value → honest "N/A" on fetch error. Never renders undefined or
	...
	return (
		<div className="mb-7">
			...
			<p className="body mb-4">
				Archimedes generates candidates through a{" "}
				<strong>debate society</strong>, its only generation path:
			</p>
			...
			<div className="card p-4">
				...
				<p className="body mb-2" style={{ fontSize: "0.9rem" }}>
					One winner, plus a panel showing rejected candidates and why they
					lost.
				</p>
				<p className="caption" style={{ color: "var(--text-3)" }}>
					LLM in use today:{" "}
		...
		<div className="card p-5 mb-7">
			...
			<div className="card-flat p-4">
				...
				<p className="caption mb-3" style={{ color: "var(--text-3)" }}>
					On the curated library, <code>num_trials=1</code>, so DSR runs
...
function ProvenanceSection() {
	return (
		<div className="card p-5 mb-7">
			...
			<p className="body mb-4">
				A hash anchored <em>after</em> a trade does not prove the reasoning
				existed beforehand. Someone could generate several rationales and keep
				the flattering one. Generation today computes a provenance hash and does{" "}
				<strong>not</strong> write it on-chain. The commit-before-trade loop
				below is the vault-path mechanism, and vault execution is roadmap:
			</p>
		...
		<div className="card p-5 mb-7">
			...
			{healthError ? (
				...
				<p className="body mb-4">
					...
					decision point can inform it. Every citation carries its arXiv ID and
					content hash.
				</p>
			)}
			<div className="card-flat p-4">
...
function ProtocolsPanel() {
	return (
		<div className="card p-5 mb-7">
			...
			<p className="body mb-3">
				Four protocols from Xia et al. 2026, an audit of why most trading-agent
				research is unreproducible. Outcome Embargo, Time-Aware Retrieval, and
				Source Tracking run on the generation path today. Hierarchy of Truth
				(read holdings from chain before a trade) is the vault-rebalance path,
				which is not live.
			</p>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<LedgerStatus tone="roadmap">Roadmap</LedgerStatus>: Arc mainnet
								is upcoming; settlement architecture is an explicit deferred
								decision
							</td>
						</tr>
					</tbody>
